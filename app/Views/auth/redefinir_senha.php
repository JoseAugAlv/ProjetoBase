...
$tituloPagina = 'Redefinir Senha - ' . App::getName();
$cssPagina = 'auth.css';
    ...
    <section class="auth-section animate-in">
        <div class="auth-container">
            <div class="auth-card" style="text-align: center;">
                ...
                <a href="<?= $basePath ?>/login" class="btn btn-primary" style="margin-top: 1.5rem;">Fazer login</a>
            </div>
        </div>
    </section>
<?php else: ?>
...
<section class="auth-section animate-in">
    <div class="auth-container">
        <div class="auth-card">
            ...
            <form action="<?= $basePath ?>/auth/redefinir-senha" method="POST" class="auth-form" onsubmit="return validarSenha()">
